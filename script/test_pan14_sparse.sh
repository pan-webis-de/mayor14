...
echo "python src/authorid_sparse.py -m test --model ~/sparse_authorid.model -r bigrampref -r bigramsuf -r bigram -r bow -r trigram -r prefix -r sufix -r punct -r wordssntc -r stopwords -r bigramstop ${testdir} ${testdir} > ${outdir}/answers_sparse.txt"
python src/authorid_sparse.py -m test --model ~/sparse_authorid.model -r bigrampref -r bigramsuf -r bigram -r bow -r trigram -r prefix -r sufix -r punct -r wordssntc -r stopwords -r bigramstop ${testdir} ${testdir} > ${outdir}/answers_sparse.txt
